...
<head>
    ...
    <script src="{{ asset('assets\js\vartical-layout.min.js') }}" defer></script>
    <script src="{{ asset('assets\js\jquery.mCustomScrollbar.concat.min.js') }}" defer></script>
    ...
    <link href="{{ asset('assets/icon/feather/css/feather.css') }}" rel="stylesheet">
...
<!-- Pre-loader end -->
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            {{-- Sidebar chat - nav - cabecera (inicio) --}}
