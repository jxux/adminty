...
<head>
    <meta charset="utf-8">
    <title>STIGold - Premium Admin Template by Colorlib</title>
    <!-- Meta -->
    ...
    <!-- Full Page Animation -->
    <link rel="stylesheet" href={{ asset('landing\assets\css\animsition.min.css') }}>
    <!-- Ionic Icons -->
...
<body>
    ...
    <div class="wrapper animsition" data-animsition-in-class="fade-in" data-animsition-in-duration="1000" data-animsition-out-class="fade-out" data-animsition-out-duration="1000">
        <div class="container">
             <nav class="navbar navbar-expand-lg navbar-light navbar-default navbar-fixed-top" role="navigation">
                <div class="container">
                    <a class="navbar-brand page-scroll" href="#main"><img src="{{ asset('landing\assets\logos\stigold.svg') }}" width="110" alt="adminity Logo"></a>
        ...
        <div class="main" id="main">
                ...
                <div class="container">
                    <div class="hero-content app-hero-content text-center">
                        <div class="row justify-content-md-center">
                            <div class="col-md-10">
                                <h1 class="wow fadeInUp" data-wow-delay="0s">STI Gold - Soluciones Tecnológicas Integrales</h1>
            ...
            <div class="footer">
                <div class="container">
                    <div class="col-md-12 text-center">
                        <img src="{{ asset('landing\assets\logos\stigold.svg') }}" width="130" alt="Adminty Logo">
    ...
    <script type="text/javascript" src="{{ asset('landing\assets\js\menu.js') }}"></script>
